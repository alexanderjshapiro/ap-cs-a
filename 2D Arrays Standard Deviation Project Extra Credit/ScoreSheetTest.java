...
public class ScoreSheetTest
{
    ...
    public void calcAvgCol()
    {
        ...
        for (int testIndex = 0; testIndex < tests.length; testIndex++)
        {
            ...
            double[] run = ScoreSheet.calcAvgCol(params);
 ...
 @Test
    public void scoresLessMeanSquaredCols()
    {
            double[][][] testsScores =
            {
                {
        ...
        for (int testIndex = 0; testIndex < testsScores.length; testIndex++)
        {
            ...
            double[][] run = ScoreSheet.scoresLessMeanSquaredCols(paramScores, paramAverage);
            String declaration = "double[] expected = ";
            assertNotNull("Array Is Null",run);
    ...
    public void stdDevCols()
    {
        ...
        {
            double[][] paramScores = testsScores[testIndex];
            double[] run = ScoreSheet.stdDevCols(paramScores);
            String declaration = "double[] expected = ";
            assertNotNull("Array Is Null",run);
